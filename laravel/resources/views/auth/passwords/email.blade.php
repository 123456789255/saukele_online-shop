                    ...
                    <div class="row">
                        <div class="col-md-12 p-5">
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="row mb-3">
                                    <label for="email"
                                        class="w-20 mobile_w-100 col-md-4 col-form-label text-md-end">{{ __('E-mail') }}</label>
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 ms-20p">
                                        <button type="submit" class="btn__catalog_in_cart btn__catalog_in_cart btn btn-primary">
                                            {{ __('Отправить') }}
                                        </button>
                                    </div>
                                </div>
