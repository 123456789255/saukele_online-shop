...
<body id="body">
    <div id="app" class="bg-white app">
                    ...
                    <ul class="menu justify-content-around" id="menu">
                        <li class="top_collapse justify-content-center d-none-desktop ul_person align-center"
                            ...
                            @elseif(Auth::user()->role == 2)
                                ...
                                <a href="{{ url('/orders') }}"><img src="/img/icons/order.svg" alt=""></a>
                        ...
                        <li class="active text-15px p-0">
                            <a class="link text-black_link" href="{{ url('/') }}">Главная</a>
                        </li>
                        <li class="text-15px p-0">
                            <a class="resources link text-black_link" href="{{ url('/catalog') }}"
                                id="link">Каталог</a>
                        </li>
                        <li class="text-15px p-0">
                            <a class="services link text-white text-white_link" href="{{ url('/#about') }}"
                                id="scrollLinkA">О нас</a>
                        </li>
                        <li class="text-15px p-0">
                            <a class="about link text-white text-white_link" href="{{ url('/#contacts') }}"
                                id="scrollLinkB">Контакты</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <footer class="z-index-0 p-relative">
